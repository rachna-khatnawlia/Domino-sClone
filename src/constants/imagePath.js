...
export default {
  ...
  birthday: require('../assets/images/birthdayPartyOffer.jpeg'),
  ...
  nonVeg: require('../assets/images/Evd/nonVeg.png'),
  ...
  // offer Home page
  offerAboveBestseller1: require('../assets/images/images.jpeg'),
  offerAboveBestseller2: require('../assets/images/images(1).jpeg'),
  offerAboveBestseller3: require('../assets/images/images(2).jpeg'),
  offerAboveBestseller4: require('../assets/images/images(3).jpeg'),
  offerAboveBestseller5: require('../assets/images/images(4).jpeg'),
  offerAboveBestseller6: require('../assets/images/images(5).jpeg'),
  offerAboveBestseller7: require('../assets/images/images(6).jpeg'),
  offerAboveBestseller8: require('../assets/images/images(8).jpeg'),
  ...
  farmHouse: require('../assets/images/farmhouse.jpeg'),
