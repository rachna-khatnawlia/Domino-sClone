...
import {
    ...
    StatusBar,
    Text,
    View, Image, FlatList, ImageBackground, Pressable, TouchableOpacity, ScrollView
} from 'react-native';
        ...
        <SafeAreaView>
            ...
            <View style={styles.Headsection3}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                    <Image source={require('../../assets/images/Evd/filter.png')} style={styles.Headsection3Img} />
                                    ...
                                    >
                                        {
                                            main.item.veg ? (
                                                <Image
                                                    source={require('../../assets/images/Evd/veg.png')}
                                                    style={{ height: 12, width: 12, left: 10, top: 7 }}
                                                />
                                            ) : (
                                                <Image
                                                    source={require('../../assets/images/Evd/nonVeg.png')}
                                                    style={{ height: 12, width: 12, left: 10, top: 7 }}
                                                />
                                            )
                                        }
                                        ...
                                        <Pressable style={styles.section3edv}>
                                            ...
                                            <Image
                                                source={require('../../assets/images/Evd/forwardArrow.png')}
                                        ...
                                        <View style={styles.section4edv}>
                                            ...
                                            <View>
                                                ...
                                                <View style={{ display: 'flex', flexDirection: 'row' }}>
                                                    ...
                                                    <Image
                                                        source={require('../../assets/images/Evd/downwardArrow.png')}
